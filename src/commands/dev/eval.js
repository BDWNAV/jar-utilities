module.exports.run = async (client, message, args) => {
  ...
  const clean = (text) => {
    if (typeof text === "string")
      return text
        ...
        .replace(/@/g, "@" + String.fromCharCode(8203));
    // Deletes zero-width spaces from the provided code (if there are any)
  ...
  try {
    ...
    if (evaled == client.token)
      evaled = "did you really think i'd let you do that"; // prevents you from leaking your token
...
module.exports.help = {
  name: "eval",
  description:
    "Executes JavaScript code. Because of the nature of the command, it is limited to bot owners.",
  aliases: "evaluate",
  ownerOnly: true,
